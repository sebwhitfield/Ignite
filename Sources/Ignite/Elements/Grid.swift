...
public struct Grid: HTML {
    ...
    public func markup() -> Markup {
        ...
        if horizontalFill {
            ...
            // This forces the grid wrapper row to wrap tightly and cleanly align items leading
            gridAttributes.append(classes: ["w-auto", "justify-content-start", "d-inline-flex"])
        }
